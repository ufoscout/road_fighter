...
pub fn disclaimer_key_pressed(
    mut next_state: ResMut<NextState<GameGlobalState>>, mut disclaimer_background: Query<(&mut DisclaimerBackground, &mut Visibility)>, keyboard_input: Res<ButtonInput<KeyCode>>) {
