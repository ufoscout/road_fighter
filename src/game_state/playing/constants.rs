...
pub const PLAYER_MAX_ACCEL_RATE: f32 = 48.;
pub const PLAYER_BRAKE_RATE: f32 = 16.;
pub const PLAYER_BRAKE_RATE_NO_FUEL: f32 = 64.;
pub const PLAYER_MAX_HSPEED: usize = 768;
